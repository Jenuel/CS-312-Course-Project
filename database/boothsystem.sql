...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 04, 2024 at 11:30 AM
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `isReservable` int DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`ProductID`),
  KEY `BoothID` (`BoothID`),
  KEY `CategoryID` (`CategoryID`),
  KEY `product_ibfk_3` (`isReservable`)
...
INSERT INTO `product` (`ProductID`, `BoothID`, `StocksRemaining`, `Price`, `CategoryID`, `isReservable`, `name`) VALUES
(1, 13, 100, 59.90, 3, 5, 'Burger'),
(107, 14, 50, 1200.00, 1, 3, 'Laptop'),
(108, 15, 150, 30.00, 7, 5, 'Art Supplies'),
(109, 16, 200, 45.50, 9, 7, 'Basketball'),
(110, 17, 75, 15.00, 10, 11, 'Skincare Kit'),
(111, 18, 60, 99.90, 1, 9, 'Smartphone'),
(112, 19, 40, 200.00, 6, 13, 'Magazine Collection'),
(113, 20, 85, 25.00, 5, 4, 'Graphic T-Shirt'),
(114, 21, 90, 75.00, 9, 8, 'Tennis Racket'),
(115, 22, 100, 10.00, 2, 2, 'Chair'),
(116, 23, 45, 300.00, 1, 2, 'Tablet'),
(117, 13, 120, 7.50, 8, 4, 'Phone Charger'),
(118, 14, 110, 9.90, 8, 12, 'Doll Set'),
(119, 15, 250, 15.00, 2, 8, 'Desk Organizer'),
(120, 16, 190, 20.00, 4, 3, 'Notebooks'),
(121, 17, 60, 500.00, 6, 11, 'Novel'),
(122, 18, 100, 12.00, 5, 7, 'Hoodie'),
(123, 19, 80, 40.00, 3, 2, 'Pizza'),
(124, 20, 90, 9.90, 7, 5, 'Pencil Set'),
(125, 21, 75, 250.00, 9, 10, 'Soccer Ball'),
(126, 22, 55, 25.00, 10, 13, 'Hair Dryer'),
(127, 23, 45, 45.00, 10, 4, 'Beauty Cream'),
(128, 13, 95, 120.00, 2, 2, 'Bookshelf'),
(129, 14, 70, 5.50, 7, 3, 'Notepad'),
(130, 15, 130, 8.00, 3, 6, 'Hotdog'),
(131, 16, 60, 180.00, 6, 9, 'Comic Book'),
(132, 17, 85, 60.00, 5, 10, 'Sweater'),
(133, 18, 120, 399.00, 9, 8, 'Volleyball'),
(134, 19, 45, 55.90, 4, 12, 'Highlighter Pack'),
(135, 20, 150, 29.90, 8, 11, 'Puzzle Set'),
(136, 21, 100, 75.50, 2, 3, 'Office Chair'),
(137, 22, 60, 399.90, 1, 2, 'Wireless Earbuds'),
(138, 23, 95, 500.00, 6, 5, 'Poetry Book'),
(139, 13, 50, 149.99, 1, 3, 'Phone Diagnostics'),
(140, 13, 30, 199.99, 1, 4, 'Laptop Repair'),
(141, 14, 40, 99.99, 10, 11, 'Health Consultation'),
(142, 15, 20, 59.99, 7, 5, 'Art Workshop'),
(143, 16, 35, 75.00, 9, 7, 'Sports Training'),
(144, 17, 25, 40.00, 10, 10, 'Public Speaking Workshop'),
(145, 18, 60, 149.99, 1, 9, 'Device Setup Assistance'),
(146, 19, 45, 69.99, 6, 12, 'Writing Workshop'),
(147, 20, 100, 20.00, 5, 11, 'Fashion Consultation'),
(148, 21, 15, 120.00, 9, 2, 'Sports Coaching'),
(149, 22, 10, 150.00, 2, 6, 'Furniture Assembly Service'),
(150, 23, 50, 89.99, 1, 8, 'Tech Support Service'),
(151, 13, 30, 30.00, 3, 3, 'Catering Service'),
(152, 14, 20, 25.00, 7, 9, 'Event Planning'),
(153, 15, 40, 50.00, 8, 10, 'Toy Customization'),
(154, 16, 35, 30.00, 4, 4, 'Stationery Design Service'),
(155, 17, 15, 60.00, 10, 7, 'Makeup Session'),
(156, 18, 100, 10.00, 1, 3, 'Computer Cleaning Service'),
(157, 19, 25, 100.00, 6, 13, 'Book Binding'),
(158, 20, 50, 200.00, 5, 5, 'Personal Styling Service');
...
DROP TABLE IF EXISTS `reserve_rules`;
...
--
-- Dumping data for table `reserve_rules`
--

INSERT INTO `reserve_rules` (`ReserveID`, `Name`, `Duration`) VALUES
(2, 'Advance Booking Duration', 'Up to 6 months in advance'),
(3, 'Maximum Reservation Period', '4 hours per session'),
(4, 'Cancellation Lead Time', '12 hours before reservation start time'),
(5, 'Consecutive Booking Gap', '30 minutes'),
(6, 'No-Show Wait Time', '15 minutes'),
(7, 'Weekly Reservation Cap', '5 reservations per week'),
(8, 'Peak Hour Restriction', '2 hours during peak times'),
(9, 'Confirmation Window', '48 hours before start time'),
(10, 'Priority Booking for Members', '1 week earlier for premium members'),
(11, 'Age Limitation', '18 years and older'),
(12, 'Group Size Restriction', 'Maximum of 10 people'),
(13, 'Penalty for Frequent Cancellations', '30-day suspension after 3 cancellations in 30 days');
...
ALTER TABLE `product`
  ...
  ADD CONSTRAINT `product_ibfk_3` FOREIGN KEY (`isReservable`) REFERENCES `reserve_rules` (`ReserveID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
